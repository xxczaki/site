...
[^3]: https://www.gov.pl/web/cyfryzacja/pomoz-swoim-bliskim--zrob-im-zakupy-online (in Polish).
...
I guess that the price will rise back to at least PLN 50 in 2022, which, granted that one decides to purchase some shares right now, will generate a decent profit.
...
[^7]: https://strefainwestorow.pl/artykuly/spolki/20210217/goldman-sachs-allegro-ccc-rekomendacje (in Polish).
